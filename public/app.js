...
// 						icon: Ext.Msg.ERROR,
// 						fn: function() {          
// 							if (responseObj.code == 401) document.location.href = '/start';
// 						}
...
Ext.define('GlobalVars', {
    singleton: true,
    userdata: Ext.decode(Ext.util.Cookies.get('AM_access'))
});
*/
